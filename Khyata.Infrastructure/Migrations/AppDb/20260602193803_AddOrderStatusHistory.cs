        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextSuspensionDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sleeve = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    ChestWidth = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    Shoulder = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    Neck = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhones_WorkspaceId_Number",
                table: "CustomerPhones",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_WorkspaceId_CreatedById",
                table: "Orders",
                columns: new[] { "WorkspaceId", "CreatedById" });

            migrationBuilder.CreateIndex(
                name: "IX_Orders_WorkspaceId_CustomerId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistories_UpdatedAt",
                table: "OrderStatusHistories",
                column: "UpdatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_WorkspaceId_Phone",
                table: "Users",
                columns: new[] { "WorkspaceId", "Phone" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_Workspaces_NextSuspensionDate",
                table: "Workspaces",
                column: "NextSuspensionDate");
